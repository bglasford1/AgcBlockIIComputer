The Control (CTL) sub-system consists of the Clock, Scalar, Timing Pulse Generator, Sequence Generator, Control Pulse Matrix and CTL Interface modules.  The following schematic sheets are used.
