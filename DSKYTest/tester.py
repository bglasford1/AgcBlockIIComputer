...
def setDisplayDigits(number, digit):
    if (number == 0):
        if (digit): setDisplayBitsHigh(1, 0, 1, 0, 1)
        else:       setDisplayBitsLow(1, 0, 1, 0, 1)
    elif (number == 1):
        if (digit): setDisplayBitsHigh(0, 0, 0, 1, 1)
        else:       setDisplayBitsLow(0, 0, 0, 1, 1)
    elif (number == 2):
        if (digit): setDisplayBitsHigh(1, 1, 0, 0, 1)
        else:       setDisplayBitsLow(1, 1, 0, 0, 1)
    elif (number == 3):
        if (digit): setDisplayBitsHigh(1, 1, 0, 1, 1)
        else:       setDisplayBitsLow(1, 1, 0, 1, 1)
    elif (number == 4):
        if (digit): setDisplayBitsHigh(0, 1, 1, 1, 1)
        else:       setDisplayBitsLow(0, 1, 1, 1, 1)
    elif (number == 5):
        if (digit): setDisplayBitsHigh(1, 1, 1, 1, 0)
        else:       setDisplayBitsLow(1, 1, 1, 1, 0)
    elif (number == 6):
        if (digit): setDisplayBitsHigh(1, 1, 1, 0, 0)
        else:       setDisplayBitsLow(1, 1, 1, 0, 0)
    elif (number == 7):
        if (digit): setDisplayBitsHigh(1, 0, 0, 1, 1)
        else:       setDisplayBitsLow(1, 0, 0, 1, 1)
    elif (number == 8):
        if (digit): setDisplayBitsHigh(1, 1, 1, 0, 1)
        else:       setDisplayBitsLow(1, 1, 1, 0, 1)
    elif (number == 9):
        if (digit): setDisplayBitsHigh(1, 1, 1, 1, 1)
        else:       setDisplayBitsLow(1, 1, 1, 1, 1)
    elif (number == -1):
        if (digit): setDisplayBitsHigh(0, 0, 0, 0, 0)
        else:       setDisplayBitsLow(0, 0, 0, 0, 0)
